from wagtail.blocks import CharBlock, ListBlock, PageChooserBlock, StructBlock, TextBlock


class WorkBlock(StructBlock):
    class Meta:
        icon = "radio-full"
        template = "work/blocks/work-block.html"
        form_classname = "label-capitalise"

    heading = TextBlock(required=True, default="Our Work")
    work_articles = ListBlock(PageChooserBlock(page_type="work.WorkArticle"))
